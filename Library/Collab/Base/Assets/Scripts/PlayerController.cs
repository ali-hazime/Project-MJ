...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isGrounded = Physics2D.OverlapBox(new Vector2(gameObject.transform.position.x - 0.3999f, gameObject.transform.position.y - 0.84f), new Vector2(0.4265f, 0.2f), 0f, groundMask);
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawCube(new Vector2(gameObject.transform.position.x -0.3999f, gameObject.transform.position.y - 0.84f), new Vector2(0.4265f, 0.2f));
